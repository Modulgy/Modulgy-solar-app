...
abstract class ModulgyApiService {
  ...
  Future<EnergyProductionResponseBody?> getMyEnergyProduction(@Path() String period, @Query("from") String from, @Query("to") String to);
  ...
  Future<EnergyProductionSummaryResponseBody> getEnergyProductionSummary(@Path() String period, @Query("from") String from, @Query("to") String to);

  @GET("/admin/energy-production/{uuid}/{period}")
  Future<EnergyProductionResponseBody> getUserEnergyProduction(@Path() String uuid, @Path() String period, @Query("from") String from, @Query("to") String to);
