...
Widget WelcomeHeader(String headerText, String descriptionText,
    {TextStyle headerStyle = AppStyles.authHeadingStyle,
    TextStyle descriptionStyle = AppStyles.authDescriptionStyle}) {
  ...
  return Row(
    ...
    children: [
      GestureDetector(
        onTap: () {
          Navigator.pushNamed(
              context, ModulgyRoute.forgotPasswordEmail.getRoute());
        },
        child: Text(
